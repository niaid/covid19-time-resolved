...
DE_RES_IN_PATH <- "data/externalData/SchulteSchrepping/differential_expression_cohort2/sample_groups/t0_covid_only/results/severity/toptables/severe-mild/cluster_labels_res.0.4/pDC--model@severity--coef@severe-mild--toptab.tsv"
