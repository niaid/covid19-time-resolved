workdir: "data/externalData/SchulteSchrepping/differential_expression_cohort1_no_cutoffs/sample_groups/t0_plus_healthy/"

#HC have no age info

FORMULAS = {
        "healthy_vs_covid" : "~ 0 + group_per_sample",
        }

COEFFICIENTS = {
        "healthy_vs_covid" : {
            "COVID-Healthy" : "(group_per_samplemild + group_per_samplesevere)/2 - group_per_samplecontrol",
            }
        }
