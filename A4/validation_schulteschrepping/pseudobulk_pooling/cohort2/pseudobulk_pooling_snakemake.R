...
sample_cols <- c(
  #"orig.ident",# This has two values per sample for some reason
  #"cartridge", 
  "donor", "sampleID", "days_after_onset", 
  "experiment", "age", "sex", 
  "date_of_sampling", "primary_complaint",
  "diagnosis", "condition", "platform",
  "group_per_sample", "who_per_sample", "disease_stage", 
  "onset_group",
  "onset_group2",
  "severity_onsetgroup2",
  "Timepoint",
  "age_numeric",
...
print("66")
samples <- paste(meta$sampleID, meta$days_after_onset, sep = "_")
