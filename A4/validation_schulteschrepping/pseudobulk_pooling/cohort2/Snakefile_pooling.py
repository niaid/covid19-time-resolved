workdir: "data/externalData/SchulteSchrepping/differential_expression_cohort2/"

SORT_GROUPS = ["Sorted", "Unsorted"]

CELL_ANNOTATION = ["cluster_labels_res.0.4", "immune.labels", "transferred_labels"]
...
rule pseudobulk_pool:
    input:
        seurat="data/externalData/SchulteSchrepping/seurat_COVID19_PBMC_jonas_FG_add_timepoint_2020-11-4.rds"
    output:
