...
#dir.create(OUT_DIR_TABLE)

PATHWAYS_DAT_PATH <- "genesets/pathway_summary-reduced_AJM_JT_09162020.xlsx"

CELL_GROUPING_IN_PATH <- "data/misc/cell_groupings_for_bubble_plots_2020_08_19.csv"
...
keep_comparisons <- c(
                      "3A" = "t0_plus_healthy--healthy_vs_covid--COVID-Healthy",
                      "3B" = "t0_covid_only--PC1--PC1",
                      "S3A" = "all_timepoints_covid_only--PC1group_onsetcontinous_interaction--days_onset_in_PC1low",
                      "S3B" = "all_timepoints_covid_only--PC1group_onsetcontinous_interaction--days_onset_in_PC1high",
                      "6C" = "all_timepoints_covid_only--PC1_onset_group_interaction--PC1High-low_in_mid",
                      "S7A" = "all_timepoints_covid_only--PC1_onset_group_interaction--PC1High-low_X_onsetMid-early",
                      "Suppnote" = "t0_covid_only--initial.Spike.corrected--initial.Spike.corrected"
                      )
