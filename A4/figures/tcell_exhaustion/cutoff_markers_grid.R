...
#colSums(mat_sorted > 1)

library(txtplot)
for(marker in colnames(mat_sorted)){
  print(marker)
  txtdensity(mat_sorted[, marker])
}


#mat_sorted <- scale(mat_sorted)
#pdf(FIG_OUT_PATH, height = 4, width =6)
#mat_sorted <- t(mat_sorted)
